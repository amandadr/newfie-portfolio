...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="HomePage">
      <Hero
        imageUrl={coppermine_2}
        text="Whaddya hat, bh'y?"
      />
      <Introduction header="Hi, I'm Amanda Roy" previewText="Welcome to my portfolio, where I hope you'll learn lots about my journey :)" imageUrl={gorge_2} />
      <NavContainer
        navLinks={homeLinks}
      />
